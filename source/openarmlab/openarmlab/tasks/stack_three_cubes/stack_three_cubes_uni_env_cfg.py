...
import openarmlab.tasks.stack_three_cubes.mdp as mdp
from openarmlab.tasks.base_unimanual_task import BaseSceneCfg


@configclass
class StackThreeCubesSceneCfg(BaseSceneCfg):
...
class ObservationsCfg:
    ...
    class CameraImageCfg(ObsGroup):
        ...
        rgbd = ObsTerm(
            func=mdp.merge_rgbd_with_segmentation,
            params={
                "gs_camera_cfg": SceneEntityCfg("gs_camera"),
                "standard_camera_cfg": SceneEntityCfg("camera"),
                "foreground_labels": ["robot", "blue_block", "green_block", "red_block", "yellow_block"],
            },
        )
...
@configclass
class StackThreeCubesEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the sorting environment."""

    # scene settings
    scene: StackThreeCubesSceneCfg = StackThreeCubesSceneCfg(num_envs=4096, env_spacing=2.5)
    # viewer settings
